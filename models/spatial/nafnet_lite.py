...
class NAFNetLite(BaseModel):
    def __init__(self, in_channels: int, out_channels: int, img_size: int, embed_dim: int = 64, depth: int = 8):
        ...
        self.blocks = nn.Sequential(*[NAFBlockLite(embed_dim) for _ in range(depth)])
