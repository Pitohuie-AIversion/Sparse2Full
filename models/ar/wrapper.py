...
class ARWrapper(nn.Module):
    ...
    def __init__(
        self, 
        single_frame_model: Optional[nn.Module] = None, 
        ...
        **kwargs
        ...
        if base_model is None and 'model' in kwargs and isinstance(kwargs['model'], nn.Module):
        ...
        if base_model is None:
            raise ValueError("ARWrapper requires a base single-frame model via 'single_frame_model' or 'model'.")
    ...
    def autoregressive_predict(
        ...
        **kwargs
        ...
        return external_predict(
            ...
            scheduled_sampling_prob=self.get_sampling_prob() if self.scheduled_sampling else 0.0,
