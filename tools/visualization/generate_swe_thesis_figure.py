...
def generate_swe_figure():
    ...
    try:
        with h5py.File(data_path, "r") as f:
            ...
            # Data shape: [T, H, W, C] -> [101, 128, 128, 1]
            data = f[f"{seed}/data"][:]
            ...
            for i, ax in enumerate(axes_flat):
                ...
                # Plot heatmap
                # origin=None (default 'upper') to match existing repo visualizations
                im = ax.imshow(frame, cmap='RdBu_r', vmin=vmin, vmax=vmax)
            ...
            # cbar attached to the whole figure axes grid
            ...
            # Save
            output_path_png = output_dir / "swe_evolution_sample.png"
            output_path_pdf = output_dir / "swe_evolution_sample.pdf"
            output_path_svg = output_dir / "swe_evolution_sample.svg"
