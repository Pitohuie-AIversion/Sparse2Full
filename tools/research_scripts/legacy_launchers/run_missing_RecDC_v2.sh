...
# ==========================================
# 目标: runs_3loss_ablation_unet/A2_RecDC
...
if ps -p $PID_UNET > /dev/null; then
   ...
   cat runs_3loss_ablation_unet/nohup_A2_RecDC.log
fi

# ==========================================
# 2. EDSR: Rec + DC (No Spec)
# ==========================================
# 目标: runs_3loss_ablation/A2_RecDC (注意文件夹区别)
# 配置: Rec=1.0, Spec=0.0, DC=1.0
...
if ps -p $PID_EDSR > /dev/null; then
   ...
   cat runs_3loss_ablation/nohup_A2_RecDC_EDSR.log
fi
