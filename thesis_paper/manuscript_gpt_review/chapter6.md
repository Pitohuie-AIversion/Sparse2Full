...
- PyTorch Contributors. (n.d.). *Reproducibility*. In *PyTorch documentation*. Retrieved December 25, 2025, from [https://docs.pytorch.org/docs/stable/notes/randomness.html](https://docs.pytorch.org/docs/stable/notes/randomness.html?utm_source=chatgpt.com).
- PyTorch Contributors. (n.d.). *torch.use_deterministic_algorithms*. In *PyTorch documentation*. Retrieved December 25, 2025, from [https://docs.pytorch.org/docs/stable/generated/torch.use_deterministic_algorithms.html](https://docs.pytorch.org/docs/stable/generated/torch.use_deterministic_algorithms.html?utm_source=chatgpt.com).
- Student. (1908). The probable error of a mean. *Biometrika, 6*(1), 1–25. [约克大学](https://www.york.ac.uk/depts/maths/histstat/student.pdf?utm_source=chatgpt.com)
- Takamoto, M., Praditia, T., Leiteritz, R., MacKinlay, D., Alesiani, F., Pflüger, D., & Niepert, M. (2022). *PDEBench: An extensive benchmark for scientific machine learning* (Version 1.0) [Data set]. DaRUS. https://doi.org/10.18419/darus-2986.
- Wang, Z., Bovik, A. C., Sheikh, H. R., & Simoncelli, E. P. (2004). Image quality assessment: From error visibility to structural similarity. *IEEE Transactions on Image Processing, 13*(4), 600–612. [滑铁卢大学电气与计算机工程系](https://ece.uwaterloo.ca/~z70wang/publications/ssim.pdf)
