...
\node[io, below=8.0cm of b_conv1-west] (coords) {Coords};
...
\coordinate (fusion_pos) at ($(b_vec-east)!0.5!(t_vec-east) + (2.0, 0, 0)$);
...
% Fusion
\draw[arrow] (b_vec-east) -- ++(0.5,0,0) |- (dot-west);
\draw[arrow] (t_vec-east) -- ++(0.5,0,0) |- (dot-west);
