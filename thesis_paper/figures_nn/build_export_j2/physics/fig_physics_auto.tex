...
% Pos Encoding
\pic[shift={(1.5 * 1.5,0,0)}] at (proj_in-east) {Box={
    name=pe,
...
\pic[shift={(1.0 * 1.5,0,0)}] at (layer1-east) {Box={
    name=ffn1,
    caption=FFN,
    fill=\ResColor,
    height=20, width=4, depth=20
...
\pic[shift={(1.5 * 1.5,0,0)}] at (ffn1-east) {Box={
    name=layer2,
    caption=Physics\\Attn,
    fill=\ResColor,
    height=20, width=4, depth=20
...
\pic[shift={(1.0 * 1.5,0,0)}] at (layer2-east) {Box={
    name=ffn2,
    caption=FFN,
    fill=\ResColor,
    height=20, width=4, depth=20
...
% Output Proj
\pic[shift={(2.0 * 1.5,0,0)}] at (ffn2-east) {Box={
    name=proj_out,
    caption=Output\\Proj,
    fill=\ConvColor,
    height=20, width=2, depth=20
