...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **UNet** | A0 | Baseline (MSE Only) | 0.1780 | 36.29 | 0.8407 | 33.44 | 0.0129 |
| **UNet** | A2 | Rec+Spec (No DC) | 0.1805 | 36.98 | **0.8660** | **22.88** | 0.0076 |
| **UNet** | A2 | Rec+DC (No Spec) | 0.1763 | 37.29 | **0.8665** | 20.65 | **0.0066** |
| **UNet** | **A3** | **Full (Rec+Spec+DC)** | **0.1575** | **37.85** | 0.8646 | 27.27 | 0.0102 |
| *Gain* | - | *Physics Gain (A3 vs A0)* | ***-11.5%*** | *+1.56 dB* | *+2.8%* | ***-18.4%*** | ***-20.9%*** |
| | | | | | | | |
| **EDSR** | A0 | Baseline (MSE Only) | **0.0978** | **62.75** | 0.9072 | **13.44** | **0.0046** |
| **EDSR** | A2 | Rec+Spec (No DC) | 0.0981 | 61.37 | **0.9076** | 13.49 | 0.0046 |
| **EDSR** | A2 | Rec+DC (No Spec) | 0.1704 | 37.86 | 0.8704 | 16.36 | 0.0048 |
| **EDSR** | **A3** | **Full (Rec+Spec+DC)** | 0.0984 | 62.40 | 0.9067 | 13.51 | 0.0047 |
| *Gain* | - | *Physics Gain (A3 vs A0)* | *+0.6%* | *-0.35 dB* | *-0.05%* | *+0.5%* | *+2.2%* |
