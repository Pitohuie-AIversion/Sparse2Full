...
try:
    ...
    print("✓ 成功导入PDEBenchVisualizer")
except ImportError as e:
    print(f"✗ 导入PDEBenchVisualizer失败: {e}")
...
def create_simple_training_curves(training_data: Dict[str, List[float]], output_dir: str):
    """创建简单的训练曲线"""
...
def main():
    ...
    create_simple_training_curves(training_data, str(output_dir))
